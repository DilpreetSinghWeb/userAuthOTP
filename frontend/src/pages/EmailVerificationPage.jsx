...
const EmailVerificationPage = () => {
    ...
    return (
        <div className="max-w-md w-full bg-gray-800 bg-opacity-0 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden">
            <motion.div
                    ...
                    <div className="flex justify-between">
                        {code.map((digit, index) => (
                            <input
                                ...
                                className="w-12 h-12 text-center text-2xl font-bold bg-gray-600 text-white border-2 border-gray-700 rounded-lg focus:border-green-500 focus:outline-none"
                            />
                        ))}
                    </div>
